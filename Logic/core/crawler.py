...
#         self.extract_movie_info(html_response, imdb_instance, URL)
#         print("new iteration")
...
#         related_links = self.get_related_links(doc)
  
#         movie['id'] = movie_id
#         movie['title'] = self.get_title(doc)
#         movie['first_page_summary'] = self.get_first_page_summary(doc)
#         movie['release_year'] = self.get_release_year(doc)
#         movie['mpaa'] = self.get_mpaa(mpaa_soup)
#         movie['budget'] = self.get_budget(doc)
#         movie['gross_worldwide'] = self.get_gross_worldwide(doc)
#         movie['directors'] = self.get_director(doc)
#         movie['writers'] = self.get_writers(doc)
#         movie['stars'] = self.get_stars(doc)
#         movie['related_links'] = related_links
#         movie['genres'] = self.get_genres(doc)
#         movie['languages'] = self.get_languages(doc)
#         movie['countries_of_origin'] = self.get_countries_of_origin(doc)
#         movie['rating'] = self.get_rating(doc)
...
#             for syn in synopsis_list:
#                 text_list = syn['htmlContent'].split("<br/><br/>")
#                 for i in range(len(text_list)):
#                     synopsis.append(text_list[i])
#             return synopsis
#         except:
